      ...
      default:
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6 max-w-7xl mx-auto mt-10 pb-12 relative z-10">
            ...
            <IslandCard title="Grammar Garden" subtitle="Taman Tata Bahasa" icon="✍️" color="bg-indigo-500" description="Master English grammar with fun exercises!" onClick={() => setActiveIsland(GameType.GRAMMAR)} mastery={getMasteryLevel(mastery[GameType.GRAMMAR])} />
